...
<link rel="manifest" href="https://vpelss.github.io/Forever_Passwords/manifest.json"> 
...
<div data-role="page" id="Menu">
  <div data-role="header">
    ...
    <h6>fPw : Password Calculator</h6>
  </div>

  <div role="main" class="ui-content">
    <div>
      <a href="#ManageAliasList" class="ui-btn ui-shadow ui-corner-all">Copy/Restore/Alias List</a>
    </div>
<center>Links below open in another page.</center>
    <div>
      <a href="https://vpelss.github.io/Forever_Passwords//README.md" target="_blank" class="ui-btn ui-shadow ui-corner-all">Help/Read Me</a>
    </div>
    ...
    <div>
      <a href="https://www.emogic.com/cgi/fp/" target="blank" class="ui-btn ui-shadow ui-corner-all">Doesn't work?</a>
    </div>
  </div>
</div>
