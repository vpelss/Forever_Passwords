...
-use a password with an odd number character length. Why? Most passwords have an even number of characters. The bad guys know this. I have set default to 11 as some sites limit passwords to 12 characters.
